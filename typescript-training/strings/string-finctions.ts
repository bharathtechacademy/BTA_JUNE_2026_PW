...
//get index of character from the string
console.log("************Getting the index of a character from the string************");
let indexOfCharacter: number = originalString.indexOf("a");
console.log(`Index of character "a": ${indexOfCharacter}`);
